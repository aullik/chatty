...
public class CommandSettings extends SettingsPanel {
   ...
   public CommandSettings(SettingsDialog d) {
      ...
      menus.add(d.addEditorStringSetting("channelContextMenu", 20, true, "Edit Channel Context Menu:", true, INFO),
            gbc);
      ...
      menus.add(d.addEditorStringSetting("timeoutButtons", 20, true, "Edit User Dialog Buttons:", true, INFO_TIMEOUT)
            , gbc);

...
public class OtherSettings extends SettingsPanel {
   ...
   private static final String INFO_WRITER = "<html><body style='width:300px'>"
         ...
         + "<li><code>%followers</code> / <code>%subscribers</code> - The follower/subscriber count (only when " +
         "Follower/Subscriber List is open)</li>"
         + "<li><code>%viewersf</code> / <code>%followersf</code> / <code>%subscribersf</code> - Formatted numbers (e" +
         ".g. 1,342)</li>"
         + "</ul>"
         + "<p>Example:</p>"
